...
class AssortmentsApi:
    ...
    def assortments_list(
        ...
        _param = self._assortments_list_serialize(
            page=page,
            page_size=page_size,
    ...
    def assortments_list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PagedResultOfAssortment]:
        """Sortimentide pärimine
    ...
    @validate_call
    def assortments_list_without_preload_content(
        self,
        page: Annotated[
            Optional[Annotated[int, Field(le=2147483647, strict=True, ge=1)]],
            Field(description="Tagastatav lehekülg"),
    ...
    def _assortments_list_serialize(
        self,
        page,
        page_size,
        evr_language,
