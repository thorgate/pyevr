...
class CertificatesApi:
    ...
    def certificates_list(
        ...
        **kwargs
    ) -> PagedResultOfCertificate:  # noqa: E501
        ...
        >>> thread = api.certificates_list(page, page_size, evr_language, async_req=True)
        >>> result = thread.get()
        ...
        :rtype: PagedResultOfCertificate
        """
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the certificates_list_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.certificates_list_with_http_info(
    ...
    def certificates_list_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.certificates_list_with_http_info(page, page_size, evr_language, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PagedResultOfCertificate, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method certificates_list" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
