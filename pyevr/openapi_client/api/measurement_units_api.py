...
class MeasurementUnitsApi:
    ...
    def measurement_units_list(
        ...
        _param = self._measurement_units_list_serialize(
            page=page,
            page_size=page_size,
    ...
    def measurement_units_list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PagedResultOfMeasurementUnit]:
        """Mõõtühikute pärimine
    ...
    @validate_call
    def measurement_units_list_without_preload_content(
        self,
        page: Annotated[
            Optional[Annotated[int, Field(le=2147483647, strict=True, ge=1)]],
            Field(description="Tagastatav lehekülg"),
    ...
    def _measurement_units_list_serialize(
        self,
        page,
        page_size,
        evr_language,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/api/measurementunits",
