...
class MeasurementUnitsApi:
    ...
    def measurement_units_list(
        ...
        **kwargs
    ) -> PagedResultOfMeasurementUnit:  # noqa: E501
        ...
        >>> thread = api.measurement_units_list(page, page_size, evr_language, async_req=True)
        >>> result = thread.get()
        ...
        :rtype: PagedResultOfMeasurementUnit
        """
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the measurement_units_list_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.measurement_units_list_with_http_info(
            page, page_size, evr_language, **kwargs
        )  # noqa: E501

    @validate_arguments
    def measurement_units_list_with_http_info(
        self,
        page: Annotated[
            Optional[conint(strict=True, le=2147483647, ge=1)],
            Field(description="Tagastatav lehekülg"),
        ...
        **kwargs
        ...
        >>> thread = api.measurement_units_list_with_http_info(page, page_size, evr_language, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PagedResultOfMeasurementUnit, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method measurement_units_list" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
        ...
        _response_types_map = {
            ...
            "200": "PagedResultOfMeasurementUnit",
        }
