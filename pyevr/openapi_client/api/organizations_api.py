...
class OrganizationsApi(object):
    ...
    def organizations_list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['code_starts_with', 'name_contains', 'page']  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'page' in local_var_params and local_var_params['page'] > -9223372036854771616:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page` when calling `organizations_list`, must be a value less than or equal to `-9223372036854771616`")  # noqa: E501
