...
class OrganizationsApi(object):
    ...
    def organizations_list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'page_size' in local_var_params and local_var_params['page_size'] > 500:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page_size` when calling `organizations_list`, must be a value less than or equal to `500`")  # noqa: E501
        if self.api_client.client_side_validation and 'page_size' in local_var_params and local_var_params['page_size'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page_size` when calling `organizations_list`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def organizations_me(self, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.organizations_me_with_http_info(**kwargs)  # noqa: E501

    def organizations_me_with_http_info(self, **kwargs):  # noqa: E501
        """Päringu teostaja enda organisatsiooni andmete pärimine  # noqa: E501

        Tagastab asutuse andmed  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.organizations_me_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method organizations_me" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
