...
class PlaceOfDeliveriesApi(object):
    ...
    def place_of_deliveries_list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'page_size' in local_var_params and local_var_params['page_size'] > 500:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page_size` when calling `place_of_deliveries_list`, must be a value less than or equal to `500`")  # noqa: E501
        if self.api_client.client_side_validation and 'page_size' in local_var_params and local_var_params['page_size'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page_size` when calling `place_of_deliveries_list`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
