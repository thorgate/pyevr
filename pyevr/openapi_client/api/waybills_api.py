...
class WaybillsApi(object):
    ...
    def waybills_add_shipments_with_http_info(self, number, add_shipments_to_waybill_request, **kwargs):  # noqa: E501
        ...
        all_params = ['number', 'add_shipments_to_waybill_request']  # noqa: E501
    ...
    def waybills_cancel_with_http_info(self, number, cancel_waybill_request, **kwargs):  # noqa: E501
        ...
        all_params = ['number', 'cancel_waybill_request']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def waybills_get(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param datetime created_after: Filtreerib veoselehed, mis on loodud hiljem või samal ajal
        :param datetime created_before: Filtreerib veoselehed, mis on loodud varem või samal ajal
    ...
    def waybills_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['created_after', 'created_before', 'last_modified_after', 'status', 'owner_code', 'transporter_code', 'receiver_code', 'van_registration_number', 'trailer_registration_number', 'text', 'sort', 'page']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def waybills_post_with_http_info(self, start_waybill_request, **kwargs):  # noqa: E501
        ...
        all_params = ['start_waybill_request']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def waybills_unload_with_http_info(self, number, unload_waybill_request, **kwargs):  # noqa: E501
        ...
        all_params = ['number', 'unload_waybill_request']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
