...
class WaybillsApi(object):
    ...
    def waybills_list(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param datetime created_after: Filtreerib veoselehed, mis on loodud hiljem või samal ajal. Kui 'created_after' ja 'created_before' on mõlemad määratud, peab nende vahe jääma 1 kuu piiresse.
        :param datetime created_before: Filtreerib veoselehed, mis on loodud varem või samal ajal. Kui 'created_after' ja 'created_before' on mõlemad määratud, peab nende vahe jääma 1 kuu piiresse.
        :param datetime last_modified_after: Filtreerib veoselehed, mis on muutunud pärast määratud aega. Kui 'last_modified_after' ja 'last_modified_before' on mõlemad määratud, peab nende vahe jääma 1 kuu piiresse.
        :param datetime last_modified_before: Filtreerib veoselehed, mis on muutunud enne määratud aega. Kui 'last_modified_after' ja 'last_modified_before' on mõlemad määratud, peab nende vahe jääma 1 kuu piiresse.
        ...
        :param str place_of_delivery_code: Filtreerib veoselehed millel on sama tarnekoha kood (tõstutundlik)
        ...
        :param int page_size: Määrab lehekülje suuruse
        :param bool include_latest_measurements: Kas lisada veoselehele viimase mõõtmise andmed (vaikimisi ei lisata)
        :param str evr_language: Defineerib keele tagastatavatele veateadetele (toetatud on väärtused \"et\" eesti keele ning \"en\" inglise keele jaoks).
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
    ...
    def waybills_list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'page_size' in local_var_params and local_var_params['page_size'] > 500:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page_size` when calling `waybills_get`, must be a value less than or equal to `500`")  # noqa: E501
        if self.api_client.client_side_validation and 'page_size' in local_var_params and local_var_params['page_size'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page_size` when calling `waybills_get`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        if 'last_modified_before' in local_var_params and local_var_params['last_modified_before'] is not None:  # noqa: E501
            query_params.append(('last_modified_before', local_var_params['last_modified_before']))  # noqa: E501
        ...
        if 'place_of_delivery_code' in local_var_params and local_var_params['place_of_delivery_code'] is not None:  # noqa: E501
            query_params.append(('place_of_delivery_code', local_var_params['place_of_delivery_code']))  # noqa: E501
        ...
        if 'include_latest_measurements' in local_var_params and local_var_params['include_latest_measurements'] is not None:  # noqa: E501
            query_params.append(('includeLatestMeasurements', local_var_params['include_latest_measurements']))  # noqa: E501
    ...
    def waybills_get(self, number, **kwargs):  # noqa: E501
        ...
        :param bool include_latest_measurements:
        :param str evr_language: Defineerib keele tagastatavatele veateadetele (toetatud on väärtused \"et\" eesti keele ning \"en\" inglise keele jaoks).
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
