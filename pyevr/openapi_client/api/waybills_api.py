...
class WaybillsApi:
    ...
    def waybills_list(
        ...
        waybill_types: Annotated[
            Optional[List[WaybillType]],
            Field(description="Veoselehe tüüp (mets või saematerjal). Vaikimisi mets."),
        ] = None,
        evr_language: Annotated[
            Optional[StrictStr],
            Field(
        ...
        :param waybill_types: Veoselehe tüüp (mets või saematerjal). Vaikimisi mets.
        :type waybill_types: List[WaybillType]
        :param evr_language: Defineerib keele tagastatavatele veateadetele (toetatud on väärtused \"et\" eesti keele ning \"en\" inglise keele jaoks).
        :type evr_language: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
    ...
    def _waybills_get_serialize(
        ...
        if waybill_types is not None:
            _query_params.append(("waybill_types", waybill_types))
