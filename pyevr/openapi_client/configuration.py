...
class Configuration(object):
    ...
    def __init__(self, host="https://evr-test.azurewebsites.net",
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'EVR-APIKEY' in self.api_key:
            auth['SecretApiKey'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'EVR-APIKEY',
                'value': self.get_api_key_with_prefix('EVR-APIKEY')
            }
        return auth
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://evr-test.azurewebsites.net",
