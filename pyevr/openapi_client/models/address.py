...
class Address(object):
    ...
    def county(self, county):
        ...
        if (self.local_vars_configuration.client_side_validation and
                county is not None and len(county) < 1):
            raise ValueError("Invalid value for `county`, length must be greater than or equal to `1`")  # noqa: E501
    ...
    def street(self, street):
        ...
        if (self.local_vars_configuration.client_side_validation and
                street is not None and len(street) < 1):
