...
class AgriculturalBiomass(HoldingBase):
    """
    AgriculturalBiomass
    """  # noqa: E501
    ...
    agricultural_area_name: Optional[
        Annotated[str, Field(strict=True, max_length=500)]
    ] = Field(default=None, description="Kõlviku nimetus", alias="agriculturalAreaName")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if agricultural_area_name (nullable) is None
        # and model_fields_set contains the field
        if (
            self.agricultural_area_name is None
            and "agricultural_area_name" in self.model_fields_set
        ):
            _dict["agriculturalAreaName"] = None
