...
class CancelWaybillRequest(BaseModel):
    ...
    reason: constr(strict=True, max_length=400, min_length=0) = Field(
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CancelWaybillRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CancelWaybillRequest:
        """Create an instance of CancelWaybillRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CancelWaybillRequest.parse_obj(obj)

        _obj = CancelWaybillRequest.parse_obj({"reason": obj.get("reason")})
        return _obj
