...
class CertificateClaim(object):
    ...
    def __init__(self, code=None, number=None, local_vars_configuration=None):  # noqa: E501
        """CertificateClaim - a model defined in OpenAPI"""  # noqa: E501
    ...
    def code(self):
        ...
        :return: The code of this CertificateClaim.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this CertificateClaim.

        [Tarneahela sertifikaadi väite kood](#operation/Certificates_List)  # noqa: E501

        :param code: The code of this CertificateClaim.  # noqa: E501
        :type: str
        """
    ...
    def number(self):
        ...
        :return: The number of this CertificateClaim.  # noqa: E501
        :rtype: str
        """
        return self._number
    ...
    def number(self, number):
        """Sets the number of this CertificateClaim.

        Sertifikaadi number  # noqa: E501

        :param number: The number of this CertificateClaim.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CertificateClaim):
            return False
