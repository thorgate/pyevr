...
class ConsolidatedAct(HoldingBase):
    """
    ConsolidatedAct
    """  # noqa: E501

    contract_number: Annotated[
        str, Field(min_length=0, strict=True, max_length=500)
    ] = Field(description="Dokumendi number", alias="contractNumber")
    ...
    sources: Optional[List[ConsolidatedActSourceItem]] = Field(
        default=None, description="Koormas olevate saadetiste päritolud"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if (
            ...
            and "forest_allocation_number" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "sources": [
                    ConsolidatedActSourceItem.from_dict(_item)
