...
class ConsolidatedAct(HoldingBase):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConsolidatedAct:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConsolidatedAct:
        """Create an instance of ConsolidatedAct from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConsolidatedAct.parse_obj(obj)

        _obj = ConsolidatedAct.parse_obj(
            {
                "type": obj.get("type"),
