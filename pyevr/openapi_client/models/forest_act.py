...
class ForestAct(HoldingBase):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ForestAct:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ForestAct:
        """Create an instance of ForestAct from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ForestAct.parse_obj(obj)

        _obj = ForestAct.parse_obj(
            {
                "type": obj.get("type"),
