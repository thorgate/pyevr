...
class InventoryAct(HoldingBase):
    """
    InventoryAct
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InventoryAct:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InventoryAct:
        """Create an instance of InventoryAct from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InventoryAct.parse_obj(obj)

        _obj = InventoryAct.parse_obj(
            {
                "type": obj.get("type"),
