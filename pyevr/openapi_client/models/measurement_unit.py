...
class MeasurementUnit(BaseModel):
    ...
    code: Optional[StrictStr] = Field(None, description="Mõõtühiku kood")
    name: Optional[StrictStr] = Field(None, description="Mõõtühiku nimetus")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MeasurementUnit:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MeasurementUnit:
        """Create an instance of MeasurementUnit from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MeasurementUnit.parse_obj(obj)

        _obj = MeasurementUnit.parse_obj(
