...
class PagedResultOfCertificate(BaseModel):
    """
    ...
    page_result: Optional[conlist(Certificate)] = Field(
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagedResultOfCertificate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagedResultOfCertificate:
        """Create an instance of PagedResultOfCertificate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagedResultOfCertificate.parse_obj(obj)

        _obj = PagedResultOfCertificate.parse_obj(
            {
                "page_number": obj.get("pageNumber"),
                "page_size": obj.get("pageSize"),
                "page_result": [
                    Certificate.from_dict(_item) for _item in obj.get("pageResult")
                ]
