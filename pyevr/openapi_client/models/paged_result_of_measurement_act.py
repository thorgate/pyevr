...
class PagedResultOfMeasurementAct(BaseModel):
    """
    ...
    page_result: Optional[conlist(MeasurementAct)] = Field(
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagedResultOfMeasurementAct:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagedResultOfMeasurementAct:
        """Create an instance of PagedResultOfMeasurementAct from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagedResultOfMeasurementAct.parse_obj(obj)

        _obj = PagedResultOfMeasurementAct.parse_obj(
            {
                "page_number": obj.get("pageNumber"),
                "page_size": obj.get("pageSize"),
                "page_result": [
                    MeasurementAct.from_dict(_item) for _item in obj.get("pageResult")
                ]
