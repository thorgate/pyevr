...
class PagedResultOfMeasurementUnit(BaseModel):
    """
    ...
    page_result: Optional[conlist(MeasurementUnit)] = Field(
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagedResultOfMeasurementUnit:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagedResultOfMeasurementUnit:
        """Create an instance of PagedResultOfMeasurementUnit from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagedResultOfMeasurementUnit.parse_obj(obj)

        _obj = PagedResultOfMeasurementUnit.parse_obj(
            {
                "page_number": obj.get("pageNumber"),
                "page_size": obj.get("pageSize"),
                "page_result": [
                    MeasurementUnit.from_dict(_item) for _item in obj.get("pageResult")
                ]
