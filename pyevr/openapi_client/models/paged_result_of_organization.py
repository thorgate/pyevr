...
class PagedResultOfOrganization(BaseModel):
    """
    ...
    page_result: Optional[conlist(Organization)] = Field(
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagedResultOfOrganization:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagedResultOfOrganization:
        """Create an instance of PagedResultOfOrganization from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagedResultOfOrganization.parse_obj(obj)

        _obj = PagedResultOfOrganization.parse_obj(
            {
                "page_number": obj.get("pageNumber"),
                "page_size": obj.get("pageSize"),
                "page_result": [
                    Organization.from_dict(_item) for _item in obj.get("pageResult")
                ]
