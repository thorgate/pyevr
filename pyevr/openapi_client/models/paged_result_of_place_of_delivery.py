...
class PagedResultOfPlaceOfDelivery(BaseModel):
    """
    ...
    page_result: Optional[conlist(PlaceOfDelivery)] = Field(
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagedResultOfPlaceOfDelivery:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagedResultOfPlaceOfDelivery:
        """Create an instance of PagedResultOfPlaceOfDelivery from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagedResultOfPlaceOfDelivery.parse_obj(obj)

        _obj = PagedResultOfPlaceOfDelivery.parse_obj(
            {
                "page_number": obj.get("pageNumber"),
                "page_size": obj.get("pageSize"),
                "page_result": [
                    PlaceOfDelivery.from_dict(_item) for _item in obj.get("pageResult")
                ]
