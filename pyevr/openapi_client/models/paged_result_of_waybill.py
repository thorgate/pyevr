...
class PagedResultOfWaybill(BaseModel):
    """
    ...
    page_result: Optional[conlist(Waybill)] = Field(
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagedResultOfWaybill:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagedResultOfWaybill:
        """Create an instance of PagedResultOfWaybill from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagedResultOfWaybill.parse_obj(obj)

        _obj = PagedResultOfWaybill.parse_obj(
            {
                "page_number": obj.get("pageNumber"),
                "page_size": obj.get("pageSize"),
                "page_result": [
                    Waybill.from_dict(_item) for _item in obj.get("pageResult")
                ]
