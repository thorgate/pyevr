...
class Price(BaseModel):
    ...
    value: Union[
        Annotated[float, Field(le=1.0e12, strict=True, ge=0.0)],
        Annotated[int, Field(le=2147483647, strict=True, ge=0)],
    ] = Field(description="Hind.")
    price_unit: UOM = Field(alias="priceUnit")
    currency_code: Annotated[str, Field(min_length=3, strict=True, max_length=3)] = (
        Field(description="3 täheline ISO 4217 valuuta kood.", alias="currencyCode")
    )
    __properties: ClassVar[List[str]] = ["value", "priceUnit", "currencyCode"]
