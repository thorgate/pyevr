...
class SecondaryWoodBiomass(HoldingBase):
    """
    ...
    cadaster: Optional[Annotated[str, Field(strict=True, max_length=500)]] = Field(
        default=None, description="Katastritunnus"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if cadaster (nullable) is None
        # and model_fields_set contains the field
        if self.cadaster is None and "cadaster" in self.model_fields_set:
            _dict["cadaster"] = None
