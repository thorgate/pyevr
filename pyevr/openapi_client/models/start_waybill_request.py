...
class StartWaybillRequest(BaseModel):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        "forest": "StartForestWaybillRequest",
        "sawn": "StartSawnWayBillRequest",
    }
    ...
    def from_json(
        cls, json_str: str
    ) -> Optional[Union[StartForestWaybillRequest, StartSawnWayBillRequest]]:
    ...
    def from_dict(
        ...
        if object_type == "StartForestWaybillRequest":
            return import_module(
                "pyevr.openapi_client.models.start_forest_waybill_request"
            ).StartForestWaybillRequest.from_dict(obj)
        if object_type == "StartSawnWayBillRequest":
            return import_module(
                "pyevr.openapi_client.models.start_sawn_way_bill_request"
            ).StartSawnWayBillRequest.from_dict(obj)

        raise ValueError(
            "StartWaybillRequest failed to lookup discriminator value from "
            + json.dumps(obj)
