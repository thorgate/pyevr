...
class Transport(object):
    ...
    def driver_name(self, driver_name):
        ...
        if (self.local_vars_configuration.client_side_validation and
                driver_name is not None and len(driver_name) < 1):
            raise ValueError("Invalid value for `driver_name`, length must be greater than or equal to `1`")  # noqa: E501
    ...
    def driver_id_code(self, driver_id_code):
        ...
        if (self.local_vars_configuration.client_side_validation and
                driver_id_code is not None and len(driver_id_code) < 1):
            raise ValueError("Invalid value for `driver_id_code`, length must be greater than or equal to `1`")  # noqa: E501
    ...
    def van_registration_number(self, van_registration_number):
        ...
        if (self.local_vars_configuration.client_side_validation and
                van_registration_number is not None and len(van_registration_number) < 1):
            raise ValueError("Invalid value for `van_registration_number`, length must be greater than or equal to `1`")  # noqa: E501
