...
class Waybill(object):
    ...
    openapi_types = {
        ...
        'waybill_latest_measurements': 'MeasurementAct'
    }
    ...
    def __init__(self, owner=None, transport=None, receiver=None, place_of_delivery=None, comment=None, departure_time=None, submission_time=None, shipments=None, pre_journey_mileage=None, user_custom_data=None, mass=None, transport_order=None, number=None, status=None, creation_time=None, cancellation_time=None, cancellation_reason=None, total_journey_mileage=None, unloading_comment=None, unloading_time=None, finishing_time=None, last_modification_time=None, notes=None, waybill_authorizations=None, waybill_latest_measurements=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._waybill_latest_measurements = None
        ...
        if waybill_latest_measurements is not None:
            self.waybill_latest_measurements = waybill_latest_measurements
    ...
    @property
    def waybill_latest_measurements(self):
        """Gets the waybill_latest_measurements of this Waybill.  # noqa: E501


        :return: The waybill_latest_measurements of this Waybill.  # noqa: E501
        :rtype: MeasurementAct
        """
        return self._waybill_latest_measurements

    @waybill_latest_measurements.setter
    def waybill_latest_measurements(self, waybill_latest_measurements):
        """Sets the waybill_latest_measurements of this Waybill.


        :param waybill_latest_measurements: The waybill_latest_measurements of this Waybill.  # noqa: E501
        :type: MeasurementAct
        """

        self._waybill_latest_measurements = waybill_latest_measurements
