...
class WaybillNote(BaseModel):
    ...
    message: Optional[StrictStr] = Field(default=None, description="Sõnum")
    __properties: ClassVar[List[str]] = ["creator", "creationTime", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "creator": WaybillNoteCreator.from_dict(obj["creator"])
