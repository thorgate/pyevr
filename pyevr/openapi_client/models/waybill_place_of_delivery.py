...
class WaybillPlaceOfDelivery(BaseModel):
    ...
    code: Optional[constr(strict=True, max_length=25)] = Field(
        None, description="EVR tarnekoha kood (kui on EVR-i lisatud tarnekoht)"
    )
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WaybillPlaceOfDelivery:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WaybillPlaceOfDelivery:
        """Create an instance of WaybillPlaceOfDelivery from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WaybillPlaceOfDelivery.parse_obj(obj)

        _obj = WaybillPlaceOfDelivery.parse_obj(
            {
                "code": obj.get("code"),
                "name": obj.get("name"),
