...
class WaybillSortField(object):
    ...
    allowable_values = [CREATIONTIMEASC, CREATIONTIMEDESC, LASTMODIFICATIONTIMEASC, LASTMODIFICATIONTIMEDESC]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """WaybillSortField - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WaybillSortField):
            return False
