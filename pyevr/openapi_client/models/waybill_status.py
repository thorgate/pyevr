...
class WaybillStatus(object):
    ...
    allowable_values = [SHIPPING, CANCELLED, UNLOADED, FINISHED]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """WaybillStatus - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WaybillStatus):
            return False
